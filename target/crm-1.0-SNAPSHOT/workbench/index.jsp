...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            window.open("${pageContext.request.contextPath}/workbench/main/index.html", "workareaFrame");
...
<div class="modal fade" id="exitModal" role="dialog">
    <div class="modal-dialog" role="document" style="width: 30%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="window.location.href='${pageContext.request.contextPath}/workbench/login.html';">确定
                </button>
            </div>
        </div>
    </div>
...
<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
    ...
    <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
        ...
        <ul id="no1" class="nav nav-pills nav-stacked">
            ...
            <li class="liClass"><a href="${pageContext.request.contextPath}/workbench/activity/index.jsp" target="workareaFrame"><span class="glyphicon glyphicon-play-circle"></span> 市场活动</a>
            </li>
