...
<head>
    ...
    <script src="${pageContext.request.contextPath}/jquery/bs_typeahead/bootstrap3-typeahead.min.js"></script>
...
<div style="position:  relative; left: 30px;">
    ...
    <div style="position: relative; top: -40px; left: 70%;">
        ...
        <button type="button" class="btn btn-default" onclick="window.location.href='${pageContext.request.contextPath}/workbench/transaction/index.jsp'">取消</button>
    </div>
    <hr style="position: relative; top: -40px;">
</div>
<form action="${pageContext.request.contextPath}/workbench/transaction/save.do" id="saveForm" class="form-horizontal" role="form" style="position: relative; top: -30px;">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <input type="hidden" value="516fb1b2f6b74eb0a97c9143cb643e36" name="activityId">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <input type="hidden" value="d084442b0cad496186dfecb891da6c26" name="contactsId">
        </div>
    </div>
