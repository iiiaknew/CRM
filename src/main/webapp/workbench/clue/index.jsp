    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#saveBtn").click(function (){
                $.ajax({
                    url : "${pageContext.request.contextPath}/workbench/clue/saveClue.do",
                    data : {
        ...
        <div style="position: relative;top: 50px;">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='${pageContext.request.contextPath}/workbench/clue/detail.do?id=8fba5e4ba3654b4d99c17917535ab1d0';">马云先生</a>
                    </td>
                    <td>动力节点</td>
                    <td>010-84846003</td>
                    <td>12345678901</td>
